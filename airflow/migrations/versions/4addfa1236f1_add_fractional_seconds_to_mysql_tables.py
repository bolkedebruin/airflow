...
def upgrade():
    if 'mysql' in context.config.get_main_option('sqlalchemy.url'):
        ...
        op.alter_column(table_name='xcom', column_name='timestamp', type_=mysql.DATETIME(fsp=6), nullable=False)
        op.alter_column(table_name='xcom', column_name='execution_date', type_=mysql.DATETIME(fsp=6), nullable=False)

        op.alter_column(table_name='chart', column_name='last_modified', type_=mysql.DATETIME(fsp=6), nullable=False)
...
def downgrade():
    if 'mysql' in context.config.get_main_option('sqlalchemy.url'):
        ...
        op.alter_column(table_name='chart', column_name='last_modified', type_=mysql.DATETIME(), nullable=False)
